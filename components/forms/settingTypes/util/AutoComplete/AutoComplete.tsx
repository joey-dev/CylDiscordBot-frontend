...
const getValueForDataFromAutoComplete = (
	dataArray: string[] | string,
	allData?: IAutoCompleteData[],
): IAutoCompleteData[] => {
...
const getValueForAutoCompleteValueFromData = (
	type: IAutoCompleteDataType,
	data?: IAutoCompleteData[],
): string | string[] => {
...
const getValueForAutoCompleteFromData = (
	type: IAutoCompleteDataType,
	data?: IAutoCompleteData[],
): string | string[] => {
